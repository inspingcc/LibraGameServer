...
public class AppDao extends JdbcDaoSupport {
    ...
    public long getPrimaryKeyData(String sql) throws DataAccessException {
     ...
     *
     * @param table  表名
     * @param params where 的参数 例如:[key,value,key1,value1] : where key=value and
     *               key1=value1
     * @return
     */
